...
def validate_template(template: str, lib_type: str | None = None) -> str | None:
    ...
    Args:
        ...
        lib_type: The library type used to restrict path depth and parent fields,
            or None to apply only the shared template rules.
    ...
    for index, part in enumerate(parts):
        ...
        allowed = (
            PARENT_FIELDS
            if lib_type == "tv_show" and index < len(parts) - 1
            else FIELDS
        )
